...
export default function Banner(){
    return (
        <div className="bg-cover h-[40rem] max-lg:h-[35rem] flex items-center text-white" style={{ backgroundImage: `url(${Background})` }}>
            <div className='flex flex-col text-center space-y-6 max-lg:items-center'>

                <div className='font-extrabold text-4xl max-lg:text-2xl space-y-2'>
                ...
                <div className='flex justify-around text-lg font-medium max-lg:pt-2 max-lg:flex'>
                    <div className='flex space-x-28 max-lg:space-x-8 max-lg:flex-wrap'>
                        <div className='flex space-x-28 max-lg:space-x-0 max-lg:flex-col'>
