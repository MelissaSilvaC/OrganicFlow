...
export default function CompanyCard(){
    return(
        <div className="w-64 h-52 m-3 flex flex-col justify-end rounded-[50px] shadow border-2 border-verde_escuro bg-verde_folha bg-cover" style={{ backgroundImage: `url(${empresa})` }}>
